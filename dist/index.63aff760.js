...
window.addEventListener("click", (e)=>{
    ...
    modals.forEach((modal)=>{
        if (e.target === modal) closeModalAnimation(modal);
    });
});
//------------------------------------------------
...
const updateDesc = ()=>{
    ...
    if (iterations === Infinity) interval();
    else index++;
};
updateDesc();
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["6DoTH","adjPd"], "adjPd", "parcelRequirea28d")
